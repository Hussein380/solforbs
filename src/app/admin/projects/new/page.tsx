...
export default function NewProjectPage() {
  ...
  const [formData, setFormData] = useState({
    ...
    features: [] as { title: string; desc: string; subtitle: string; image: string }[]
  });
  ...
  if (isSuccess) {
    return (
      <div style={{ maxWidth: 600, margin: "100px auto", textAlign: "center", background: "#F0FDF4", padding: 60, borderRadius: 24, border: "1px solid #BBF7D0" }}>
        ...
        <h1 style={{ fontSize: 32, fontWeight: 800, color: "#166534", marginBottom: 16 }}>Project Saved!</h1>
        <p style={{ fontSize: 16, color: "#15803D", marginBottom: 32 }}>Your new platform has been successfully uploaded to the database and is now live on the frontend.</p>
  ...
  return (
    <div style={{ maxWidth: 800, margin: "0 auto", paddingBottom: 100 }}>
      <div style={{ marginBottom: 32, display: "flex", alignItems: "center", gap: 16 }}>
        ...
        <h1 style={{ fontSize: 28, fontWeight: 800, color: "#0F172A" }}>Add New Project</h1>
      </div>
            ...
            <div>
              ...
              <div style={{ display: "flex", gap: 12, flexWrap: "wrap", marginBottom: 12 }}>
                {formData.gallery.map((img, i) => (
                  <img key={i} src={img.url} alt="Gallery" style={{ height: 100, width: 140, objectFit: "cover", borderRadius: 8, border: "1px solid #E2E8F0" }} />
                ))}
              </div>

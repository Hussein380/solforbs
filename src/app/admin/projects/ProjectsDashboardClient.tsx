...
export default function ProjectsDashboardClient({
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 28 }}>
      ...
      {/* ── Executive Metric KPI Cards (4-Column Matrix) ──────────── */}
      <div
        style={{
          display: "grid",
      ...
      >
        ...
        >
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
            ...
            <div style={{ width: 8, height: 8, borderRadius: "50%", background: "#16A34A", boxShadow: "0 0 0 4px rgba(22, 163, 74, 0.15)" }} />
          </div>
          <div style={{ display: "flex", alignItems: "baseline", gap: 8 }}>
            <span style={{ fontSize: 28, fontWeight: 800, color: "#0F172A", letterSpacing: "-0.03em" }}>
              {metrics.live}
            </span>
            <span style={{ fontSize: 12.5, color: "#16A34A", fontWeight: 600 }}>Active Deployments</span>
          </div>
        </div>
        ...
        >
          ...
          <div style={{ display: "flex", alignItems: "baseline", gap: 8 }}>
            ...
            <span style={{ fontSize: 12.5, color: "#D97706", fontWeight: 600 }}>Under Active Build</span>
          </div>
        </div>

        {/* Metric 3: Total Sectors */}
        <div
          style={{
            background: "#FFFFFF",
            padding: "20px",
        ...
        >
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
            ...
            <Layers size={16} color="#0E5BFF" />
          </div>
          <div style={{ display: "flex", alignItems: "baseline", gap: 8 }}>
            <span style={{ fontSize: 28, fontWeight: 800, color: "#0F172A", letterSpacing: "-0.03em" }}>
              {metrics.industries}
            </span>
            <span style={{ fontSize: 12.5, color: "#64748B", fontWeight: 500 }}>Vertical Industries</span>
          </div>
        </div>

        {/* Metric 4: Total Feature Modules */}
        <div
          style={{
            background: "#FFFFFF",
            padding: "20px",
        ...
        >
          ...
          <div style={{ display: "flex", alignItems: "baseline", gap: 8 }}>
            ...
            <span style={{ fontSize: 12.5, color: "#64748B", fontWeight: 500 }}>Product Feature Sets</span>
          </div>
        </div>
      </div>
